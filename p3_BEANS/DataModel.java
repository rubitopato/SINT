...
public class DataModel {
     ...
     public static XPath xpath = xpathFactory.newXPath();//creamos el xpath que necesiaremos para navegar por los documentos xml
     public static HashMap<String,Document> mapDocs = new HashMap<String,Document>();// mapa donde guardaremos los documentos que vayamos leyendo y no tengan errores
     public static ArrayList<String> yearsArray = new ArrayList<String>();//arraylist con los años de los albumes en el mapa que se utilizan como llaves para acceder a los documentos del mapa
     public static ArrayList<String> errorFiles = new ArrayList<String>();//arraylist con las URL de los documentos que no se encuentran entre 1980-2021
     public static ArrayList<String> fatalFiles = new ArrayList<String>();//artaylist con las URL de los documentos que a la hora de leerlos dieron alguna excepcion de algun tipo
     public static ArrayList<String> tagsErrorsXML = new ArrayList<String>();//arraylist con las MuML tags de los documentos que no se encuentran entre 1980-2021
     public static ArrayList<String> tagsFatalsXML = new ArrayList<String>();//artaylist con las MuML tags de los documentos que a la hora de leerlos dieron alguna excepcion de algun tipo
	DataModel(){	}

    public static void readDocument(){//este metodo es llamado en el init del servlet y procesa todos los documentos xml y guarda cada valor en su respectivo lugar
	...
	DocumentBuilder dBuilder = dbFactory.newDocumentBuilder();//creamos el dBuilder para poder procesar los documentos xml
     ...
     public static ArrayList<String> getQ1ErrorFiles(){//devuelve la arrayList de errores para representarla en el FrontEnd   
          return errorFiles;
     }
     public static ArrayList<String> getQ1ErrorFilesXML(){   //devuelve la arrayList de errores para representarla en el FrontEnd (modo auto)
          return tagsErrorsXML;
     }
     public static ArrayList<String> getQ1FatalFiles(){   //devuelve la arrayList de errores fatales para representarla en el FrontEnd 
          return fatalFiles;
     }
     public static ArrayList<String> getQ1FatalFilesXML(){//devuelve la arrayList de errores fatales para representarla en el FrontEnd  (modo auto)
          return tagsFatalsXML;
     }
     
     public static ArrayList<String> getQ1Countries(){//este metodo devuelve los paises donde alguno de los albumes leidos fueron publicados
     ...
     public static ArrayList<Album> getQ1Albums(String country){//este metodo devuelve todos los albumes publicados en el pais que recibe como parametro pcountry
     ...
     public static ArrayList<Song> getQ1Songs(String country, String paid){//este metodo devuelve una lista con ls canciones cuyo alguno de sus generos sea Pop de un album especifico de un pais especifico
     ...
     static class AlbumComparator implements Comparator<Album>{//con esta clase comparator podemos ordenar los albumes segun el criterio especificado
     ...
     static class SongComparator implements Comparator<Song>{//con esta clase comparator podemos ordenar las songs segun el criterio especificado
